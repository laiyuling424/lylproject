...
public class PageView extends View {
    ...
    private ValueAnimator animName;
    ...
    private void initIntAnim() {
        ...
        // name
        animName = ValueAnimator.ofInt(0, 100);
        animName.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                progressName = (int) animation.getAnimatedValue();
                invalidate();
            }
        });
        animName.setDuration(5000);
