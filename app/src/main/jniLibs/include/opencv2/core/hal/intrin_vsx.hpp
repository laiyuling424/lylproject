...
inline v_uint32x4 v_load_expand_q(const uchar *ptr) { return v_uint32x4(vec_uint4_set(ptr[0], ptr[1], ptr[2], ptr[3])); }

inline v_int32x4 v_load_expand_q(const schar *ptr) { return v_int32x4(vec_int4_set(ptr[0], ptr[1], ptr[2], ptr[3])); }
...
/** Popcount **/
template<typename _Tpvec>
inline v_uint32x4 v_popcount(const _Tpvec &a) { return v_uint32x4(vec_popcntu(vec_uint4_c(a.val))); }
...
inline v_int32x4 v_round(const v_float64x2 &a) { return v_int32x4(vec_mergesqo(vec_ctso(vec_round(a.val)), vec_int4_z)); }
