...
public class BaseDao<T> implements IDao<T> {
    ...
    // 获取对应关系 name = "dabaicai" --> Map<name,dabaicai>
    ...
    public List<T> queryAll() {
        ...
        Cursor cursor = mSqLiteDatabase.rawQuery("select * from " + mTableName, null);
        //查询全部的逻辑与条件查询的逻辑一样
        while (cursor.moveToNext()) {
            try {
                Object item = mEntityClass.newInstance();
