...
class RadarView @JvmOverloads constructor(
    ...
    private fun initAttributes(context: Context, attrs: AttributeSet?) {
        ...
        try {
            a?.run {
                radius = a.getDimension(R.styleable.RadarView_radius, context.dpf2pxf(100f))
                score = a.getDimension(R.styleable.RadarView_score, context.dpf2pxf(1.5f))
                lineWidth = a.getDimension(R.styleable.RadarView_lineWidth, context.dpf2pxf(3f))

                scoreLineColor = a.getColor(R.styleable.RadarView_scoreLineColor, Color.BLUE)
                scoreColor = a.getColor(R.styleable.RadarView_scoreColor, Color.BLUE)

                later = a.getInt(R.styleable.RadarView_later, 5)
                n = a.getInt(R.styleable.RadarView_n, 5)
